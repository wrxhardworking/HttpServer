...
#define LOG_INFO LOG_LEVER(getLogger(), LogLever::Lever::INFO)

#define LOG_DEBUG  LOG_LEVER(getLogger(),LogLever::Lever::DEBUG)

#define LOG_ERROR  LOG_LEVER(getLogger(),LogLever::Lever::ERROR)

#define LOG_FATAL  LOG_LEVER(getLogger(),LogLever::Lever::FATAL)

#define LOG_WARN   LOG_LEVER(getLogger(),LogLever::Lever::WARN)

#define LOG_ALERT  LOG_LEVER(getLogger(),LogLever::Lever::ALERT)

#define LOG_NOTICE LOG_LEVER(getLogger(),LogLever::Lever::NOTICE)

#define LOG_NOTSET LOG_LEVER(getLogger(), LogLever::Lever::NOTSET)
...
public:
    ...
    LogEvent& operator<<(const char* content);
    LogEvent& operator<<(int content);
private:
...
static Logger::ptr getLogger(){
    static Logger::ptr logger (new Logger("httpServer"));
    LogFormatter::ptr formatter(new LogFormatter("%c %d{%Y-%m-%d %H:%M:%S} %p 线程id:%t %f %l %m"));
